...
import { BsFillHeartPulseFill, BsFillBuildingsFill } from "react-icons/bs";
...
import { MdFamilyRestroom, MdMedicalServices } from "react-icons/md";
import { PiBrain, PiVirus } from "react-icons/pi";
import { LuBaby, LuBrainCircuit } from "react-icons/lu";
import {
  FaMicroscope,
  FaLungsVirus,
  FaBaby,
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                ...
                >
                  <div className="feature-box-xl mb-20">
                    <span className="icon-cell">
                      <GiLiver size={70} style={{ color: "rgb(2, 2, 136)" }} />
                    </span>
                  </div>
                  <div className="icon-content">
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                ...
                >
                  <div className="feature-box-xl mb-20">
                    <span className="icon-cell">
                      <PiBrain size={70} style={{ color: "rgb(2, 2, 136)" }} />
                    </span>
                  </div>
                  <div className="icon-content">
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                ...
                >
                  <div className="feature-box-xl mb-20">
                    <span className="icon-cell">
                      <LuBaby size={70} style={{ color: "rgb(2, 2, 136)" }} />
                    </span>
                  </div>
                  <div className="icon-content">
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                ...
                >
                  <div className="feature-box-xl mb-20">
                    <span className="icon-cell">
                      <PiVirus size={70} style={{ color: "rgb(2, 2, 136)" }} />
                    </span>
                  </div>
                  <div className="icon-content">
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                ...
                >
                  <div className="feature-box-xl mb-20">
                    <span className="icon-cell">
                      <FaBaby size={70} style={{ color: "rgb(2, 2, 136)" }} />
                    </span>
                  </div>
                  <div className="icon-content">
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                ...
                >
                  <div className="feature-box-xl mb-20">
                    <span className="icon-cell">
                      <FaXRay size={70} style={{ color: "rgb(2, 2, 136)" }} />
                    </span>
                  </div>
                  <div className="icon-content">
